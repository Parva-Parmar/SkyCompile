    ...
    <div className="relative" ref={dropdownRef}>
      <div className="relative">
        <div className="absolute left-3 top-1/2 transform -translate-y-1/2 flex items-center gap-2">
          {loading ? (
            <div className="w-4 h-4 animate-spin rounded-full border-2 border-[var(--text-muted)] border-t-transparent"></div>
          ) : (
        ...
        <input
          ...
          className="w-full pl-10 pr-10 py-2 bg-[var(--bg-elevated)] border border-[var(--border-color)] rounded-lg text-[var(--text-primary)] placeholder-[var(--text-muted)] focus:outline-none focus:ring-2 focus:ring-[var(--accent)] focus:border-transparent disabled:opacity-50"
        />
      ...
      {isOpen && suggestions.length > 0 && (
        <div className="absolute z-50 w-full mt-1 bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-lg shadow-lg max-h-60 overflow-y-auto">
          {suggestions.map((suggestion, index) => (
            ...
            >
              <div className="w-8 h-8 bg-[var(--bg-elevated)] border border-[var(--border-color)] rounded-full flex items-center justify-center flex-shrink-0">
